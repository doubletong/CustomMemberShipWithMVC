namespace SIG.WebUI.Migrations
{
    using Models;
    using System;
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<SIG.WebUI.Models.DataContext>
    {
        ...
        protected override void Seed(SIG.WebUI.Models.DataContext context)
        {
